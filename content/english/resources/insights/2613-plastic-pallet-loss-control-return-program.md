...
1. **Detect**: system balance or receiving check shows a shortage.
2. **Classify**: wrong count, delayed return, customer hold, carrier issue, damage write-off, or unknown loss.
3. **Assign owner**: logistics, customer service, sales account owner, carrier manager, or warehouse supervisor.
4. **Set deadline**: each case receives a recovery or billing deadline.
5. **Close**: returned, exchanged, charged, written off, or escalated.
