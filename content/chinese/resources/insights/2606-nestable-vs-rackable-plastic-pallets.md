...
2. **按场景分配结构**：套叠、上架或双规格。
3. **先做小范围试点**，用实测数据校验假设（可参考[90天试点框架](/resources/insights/2604-plastic-pallet-pilot-program/)）。
4. **锁定RFQ参数**，在询价前写清梁跨度、载荷画像、验收标准（可参考[RFQ规格核对清单](/resources/insights/2605-plastic-pallet-rfq-specification-checklist/)）。
