...
challenges:
  ...
  - "El impacto del montacargas reduce la vida útil en pasillos de alta rotación"
  - "Se confunden palets de exportación de un solo uso con palets de circulación interna"
  - "El costo de retorno de vacíos se ignora hasta que el programa escala"
selection_factors:
  - title: "Modo de almacenamiento"
    text: "Almacenamiento en piso, estantería sobre vigas, drive-in y zonas temporales requieren bases diferentes."
  - title: "Comportamiento de la carga"
    text: "Cajas, sacos, tambores y cargas puntuales se comportan distinto aunque tengan el mismo peso."
